...
// PC = voix albanaise native (aucune correction)
// Mobile = voix anglaise + corrections phonétiques simples
// ======================================================
...
function speak(text, lang) {
  ...
  // PC → texte original
  // Mobile → corrections phonétiques simples
  if (isAlbanian && isMobile) {
